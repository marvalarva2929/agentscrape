...
Revises: 9e36696d05e8
Create Date: 2026-09-18 12:00:00.000000

`extraction_method` gains the value `directory` in the model only: the column
is a VARCHAR with no CHECK constraint, and "directory" fits its length.
"""
